...
export const config  = {
    ...
    API_CONFIG: {
        ...
        staticBaseUrl: [
            'https://aapi.xes.al/api/v1',
            'https://114514.114360.xyz/api/v1'
        ],
    ...
    SITE_CONFIG: {
        siteName: 'DoriyaNet',
        siteDescription: 'DoriyaNet',
        // copyright会自动使用当前年份
        copyright: `© ${new Date().getFullYear()} DoriyaNet. All Rights Reserved.`,
